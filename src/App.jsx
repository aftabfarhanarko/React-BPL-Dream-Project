...
function App() {
  ...
  return (
    <>
      ...
      <div className="flex justify-between w-[1100px] mx-auto mt-5 mb-4">
      ...
      </div>
     {
      ...
      >
        <AbabolePlayer playerDataFeatch={playerDataFeatch} setBalences={setBalences}></AbabolePlayer>
      </Suspense> :  <SecleatPlayer></SecleatPlayer>     
     }
